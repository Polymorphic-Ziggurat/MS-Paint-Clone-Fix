...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Canvas
        self.DrawCanvas = tk.Canvas(self.master, width=500, height=300, bg='#ffffff')
        self.DrawCanvas.grid(row=0, column=1, padx=10, pady=10)
        ...
        self.clearButton.grid(row=0, column=0, padx=10, pady=10)
        self.Pwidth.grid(row=1, column=0, padx=10, pady=10)
    ...
    def drawArcRelease(self, event):
        self.xCoor1 = event.x
        self.yCoor1 = event.y
        gradient = (self.yCoor1 - self.yCoor) / (self.xCoor1 - self.xCoor) if self.xCoor1 != self.xCoor else 0
